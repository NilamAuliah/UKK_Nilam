...
<div class="wrapper">
  ...
  <div class="row">
    <div class="col">
      ...
      <input name="dari" type="date" class="form-control" placeholder="">
    </div>
    <div class="col">
        <label for="">Sampai</label>
      <input name="sampai" type="date" class="form-control" placeholder="">
    </div>
    <div class="col">
...
<table class="table table-bordered w-100 table-hover mt-5">
<thead>
  <tr>
    <th>No</th>
    <th>Tanggal</th>
